...
public static final String TAG = CodeBlockSpan.class.getSimpleName();
    ...
    public void draw(Canvas canvas, CharSequence text, int start, int end, float x, int top, int y, int bottom, Paint paint) {
        Log.i(TAG, this.toString() + "draw: canvas = [" + canvas + "], text = [" + text + "], start = [" + start + "], end = [" + end + "], x = [" + x + "], top = [" + top + "], y = [" + y + "], bottom = [" + bottom + "], paint = [" + paint + "]");
        float size = paint.getTextSize();
        paint.setTextSize(size * TEXT_SIZE_SCALE);
        paint.setTypeface(Typeface.MONOSPACE);
    ...
    public void chooseHeight(CharSequence text, int start, int end, int spanstartv, int v, Paint.FontMetricsInt fm) {
        Log.e(TAG, this.toString() + "| chooseHeight: text = "+ text.subSequence(start, end)+", spanstartv = [" + spanstartv + "], v = [" + v + "], fm = [" + fm + "]");
        int num = lines.size();
